    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            ...
            if let templateImage = UIImage(named: "Status")?.withRenderingMode(.alwaysTemplate) {
                ...
                cell.summaryStatusImage.tintColor = UIColor(red: 241/255.0, green: 107/255.0, blue: 182/255.0, alpha: 1)
            }
            return cell
        default:
            ...
            if let templateImage = UIImage(named: "Status")?.withRenderingMode(.alwaysTemplate) {
                ...
                cell.summaryStatusImg.tintColor = UIColor(red: 241/255.0, green: 107/255.0, blue: 182/255.0, alpha: 1)
            }
