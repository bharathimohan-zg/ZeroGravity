...
class CustomerDashBoardViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if #available(iOS 13.0, *) {
           ...
           dashboardSegment.selectedSegmentTintColor = LoginViewController.hexStringToUIColor(hex: hexaColor)
        } else {
           dashboardSegment.tintColor = LoginViewController.hexStringToUIColor(hex: hexaColor)
        }
...
func updateLayerProperties() {
    ...
    self.backgroundColor = LoginViewController.hexStringToUIColor(hex: hexaColor)}
